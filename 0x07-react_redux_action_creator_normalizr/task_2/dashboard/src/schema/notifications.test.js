...
describe('getAllNotificationsByUser', () => {
    ...
    it('has correct notification entity', () => {
        const expected = {
        ...
        expected(notification).toEqual(expected);
    });
});
